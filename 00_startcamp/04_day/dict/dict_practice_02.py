...
print(len(ssafy['location'])  # len : 한 행에서 열의 갯수를 세는 함수.
...
for lang in ssafy['language'].key():
    print(lang)
...
for name in saffy['classes]['gj'].values():
    print(name)
...
for name, attr in ssafy['language']['python']['framworks'].items():
